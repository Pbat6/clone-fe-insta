...
function SideBar() {
  ...
  return (
    <div ref={targetRef} className="col-start-1 col-span-2">
      <div
        id="wrap"
        className="container px-[12px] pt-[8px] pb-[20px] flex flex-col gap-y-[4px] h-screen border-r-[1px]"
      >
        <div className="w-full h-[92px] px-[12px] pt-[25px] pb-[16px] cursor-pointer">
          <svg
            id="text-logo"
          ...
          <svg
            id="image-logo"
            aria-label="Instagram"
            className="x1lliihq x1n2onr6 x5n08af hidden"
            fill="currentColor"
            height="24"
            role="img"
            viewBox="0 0 24 24"
        ...
        <div className="w-full p-[12px] flex gap-x-[16px] items-center hover:bg-[#f2f2f2] rounded-[8px] cursor-pointer">
          ...
          />
          <p id="text-profile" className="text-[16px]">
            Profile
          </p>
        </div>
